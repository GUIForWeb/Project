apps.themes.interfaces.modules.InterfaceTheme = function() {
	this.init = function() {
		...
		this.click = new InterfaceThemeClick();
		this.click.__proto__ = this.controller;
		this.bTrial = new BarThemeTrial();
		this.bTrial.__proto__ = this.controller;
		this.cmTrial = new ContextMenuThemeTrial();
		this.cmTrial.__proto__ = this.controller;
		this.tmTrial = new TaskbarMenuThemeTrial();
		this.tmTrial.__proto__ = this.controller;
