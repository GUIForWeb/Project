	function Form(){
		...
		this.setFunction = function(innerHTML,topic){
			...
			tag.find("input[type='text']").attr("onkeydown",this.guiName+".change"+this.nameStandart(topic)+"Theme(this)").attr("onfocusout",this.guiName+".change"+this.nameStandart(topic)+"Theme(this)");
			return tag;
		}
