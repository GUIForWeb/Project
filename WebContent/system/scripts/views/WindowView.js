system.views.WindowView = function(windowModel) {
	...
	this.init = function() {
		...
		this.cWidth = this.oWidth - (this.oBorderWidth*2);
		this.cHeight = this.oHeight - (this.oBorderWidth*2) - this.hHeight;
		this.cLeft = this.oBorderWidth;
		this.cTop = this.hHeight + this.oBorderWidth;
